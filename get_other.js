...
var sql = "select id,username from other order by id desc";
var sqltw = "select count(id) cnt from other_timeline where tweet_id = ?";
var sqlwc = "select id from other_word where word = ?";
var sqlins = "insert into other_timeline ( tweet_id, username, body, wakachi, create_at) values ( ?, ?, ?, ?, ?)";
var sqlinstw = "insert into other_timeline_word (t_id, w_id) values (?, ?)";
var sqlinsw = "insert into other_word (word,hindo) values (?,1)";
var sqlupw = "update other_word set hindo = hindo + 1 where word = ?";
var n = 0;
